...
#### We also [provide here](https://github.com/nlemanski/ABS_Honeybee_Foraging/ODD) a description of the model using the Overview, Design concepts, and Details (ODD) protocol.
